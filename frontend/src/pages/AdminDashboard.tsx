          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {/* Total Users */}
                <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/80 p-5 group hover:border-blue-500/30 transition-all duration-300">
                ...
                {/* Hostel Blocks */}
                <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/80 p-5 group hover:border-emerald-500/30 transition-all duration-300">
                  <div className="flex items-start justify-between">
                    <div>
                    ...
                    <div className="p-3 bg-gradient-to-br from-emerald-500/20 to-green-600/10 rounded-xl border border-emerald-500/20">
                ...
                {/* Total Rooms */}
                <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/80 p-5 group hover:border-purple-500/30 transition-all duration-300">
                  <div className="flex items-start justify-between">
                    <div>
                    ...
                    <div className="p-3 bg-gradient-to-br from-purple-500/20 to-violet-600/10 rounded-xl border border-purple-500/20">
                ...
                {/* Pending Swaps */}
                <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800/80 p-5 group hover:border-amber-500/30 transition-all duration-300">
                  <div className="flex items-start justify-between">
                    <div>
                    ...
                    <div className="p-3 bg-gradient-to-br from-amber-500/20 to-orange-600/10 rounded-xl border border-amber-500/20">
